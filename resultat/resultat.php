                            ...
                            <center>
						      ...
						      ?>
                                ...
                                if(isset($_SESSION['prof'])){
                                    ...
                                    $var.="<th>Total</th>";
									$var.="</tr>";
                                    if (count($_SESSION['prof'])<10){
                                        $count=0;
                                    }
                                    else{
                                        $count=count($_SESSION['prof'])-10;
                                    }
                                    // permet d'afficher le dernier résultat en haut du tableau
                
                                    for($i=count($_SESSION['prof'])-1;$i>$count;$i--){

                                        $var.="<tr>";
                                        $var.="<td>".$_SESSION['prof'][$i]['numdos']."</td>";
                                        $var.="<td>".$_SESSION['prof'][$i]['dons']."</td>";
                                        $var.="<td>".$_SESSION['prof'][$i]['KM']."</td>";
                                        $var.="<td>".$_SESSION['prof'][$i]['total']."</td>";
                                        $var.="</tr>";
